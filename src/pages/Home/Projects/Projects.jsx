            ...
            <div className="  px-5">
              ...
              <ul className="space-y-3">
                <li className="">
                  ...
                  articles. They can also subscribe to the website for different
                  periods of time and update their profile information.
                </li>
                <li className="">
                  <span className="font-bold text-white">
                    {" "}
           ...
           <div className="  px-5 ">
              ...
              <ul className="space-y-3 text-justify">
                <li className="">
                  ...
                  Users can take any service, add, update, and delete their own
                  services.
                </li>
                <li className="">
                  <span className="font-bold text-white">
